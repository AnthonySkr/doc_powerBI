"""
Écriture du document Word en parcourant le plan de `config.yaml`.
...
from core.expressions import evaluate, printable, render, render_list, resolve_items
from core.models import DocLink
from report_generator.merge import PreviousDocument
from report_generator.word import fields, shapes, tables
from report_generator.word.body import Body
from report_generator.word.figures import FigureWriter
from report_generator.word.links import LinkIndex
from report_generator.word.merging import MergeWriter
from report_generator.word.styles import StyleResolver
from report_generator.word.values import column_width, format_template, number
