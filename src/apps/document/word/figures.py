...
from src.apps.document.word import fields, shapes
from src.apps.document.word.body import Body
from src.apps.document.word.styles import StyleResolver
from src.apps.document.word.values import format_template, number, numbering_mode
from src.shared.config import render, resolve_items
