...
from src.apps.document.filters import filter_steps, filter_tables, group_measures
from src.apps.document.references import index_group_members
...
from src.shared.selection import organize_page
