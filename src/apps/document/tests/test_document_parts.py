...
from src.apps.document.references import index_usages, visual_options
from src.apps.document.word.fields import (
...
class ReplaceInParagraphTest(unittest.TestCase):
    def test_remplacement_dans_un_seul_run(self):
        ...
        self.assertEqual(replace_in_paragraph(paragraph, "Titre intercalaire 1", "Ventes"), 1)
    ...
    def test_tabulation_conservee(self):
        ...
        replace_in_paragraph(paragraph, "Titre intercalaire 1", "Ventes")
    ...
    def test_texte_absent(self):
        ...
        self.assertEqual(replace_in_paragraph(paragraph, "Titre", "Ventes"), 0)
...
class TableOfContentsTest(unittest.TestCase):
    def test_champ_marque_a_recalculer(self):
        ...
        self.assertEqual(mark_toc_fields_dirty(document.element.body), 1)
        dirty = [
            fc.get(qn("w:dirty"))
    ...
    def test_niveaux_modifies(self):
        ...
        mark_toc_fields_dirty(document.element.body, "1-3")
    ...
    def test_pageref_ignore(self):
        ...
        self.assertEqual(mark_toc_fields_dirty(document.element.body), 0)

    def test_niveaux_sans_option(self):
        self.assertEqual(set_toc_levels(' TOC \\o "1-2" \\h ', "1-3"), ' TOC \\o "1-3" \\h ')
...
class UsagesTest(unittest.TestCase):
    ...
    def test_usages_pointent_vers_le_visuel(self):
        ...
        options = visual_options(DocConfig())

        index_usages(self._report(), measures, options)
    ...
    def test_mesure_inconnue_ignoree(self):
        ...
        index_usages(self._report(), measures, {})
