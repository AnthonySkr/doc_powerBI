...
from src.apps.document.merge import orphans
from src.apps.document.merge.changes import ChangeLog
from src.apps.document.merge.markers import Marker
from src.apps.document.merge.previous import CHANGED, NEW, UNCHANGED, PreviousDocument
from src.apps.document.merge.previous import read as read_previous
from src.apps.document.merge.smart import merge as apply_merge
