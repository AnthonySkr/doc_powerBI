...
from src.apps.document import filters, references
from src.shared import selection
from src.shared.config import DocConfig
from src.shared.models import DaxMeasure, PowerBIReport, SemanticModel
...
def build_context(
    ...
    report.pages = selection.filter_pages(report.pages, config)
