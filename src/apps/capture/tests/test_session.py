...
from src.apps.capture.fake import FakeRecorder, solid_png
from src.apps.capture.geometry import Rect
from src.apps.capture.library import CaptureLibrary
from src.apps.capture.recorder import CaptureError
from src.apps.capture.session import run
from src.shared import console
from src.shared.models import ReportPage, Visual
