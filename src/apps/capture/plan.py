...
visuels viennent du rapport `.pbip`, que `src.apps.extract.report` a déjà lu. On
...
soit (`python -m src.apps.capture --plan`).
...
from src.apps.capture.geometry import Rect, Size, union
