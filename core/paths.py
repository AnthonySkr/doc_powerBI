...
Le plan et le template se cherchent à trois endroits, dans cet ordre : le
chemin donné tel quel, le dossier de l'application, puis — pour un exécutable —
le dossier temporaire où il déplie ce qu'il embarque. Les fichiers posés à côté
de l'exécutable font donc foi : c'est ainsi qu'on adapte le plan sans
reconstruire.
"""
