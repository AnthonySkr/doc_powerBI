...
from core.expressions import resolve_options
...
# Le plan, à côté de l'exécutable ou à la racine du dépôt.
DEFAULT_CONFIG_PATH = "config.yaml"

# Dossier de sortie retenu si le plan n'en désigne aucun.
DEFAULT_OUTPUT_DIR = "doc"

# Dossier des captures retenu si le plan n'en désigne aucun.
